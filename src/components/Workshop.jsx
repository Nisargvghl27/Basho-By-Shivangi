  ...
  return (
    ...
    >
      ...
      <div className="layout-container max-w-7xl mx-auto px-4 md:px-12 lg:px-24">
        {loading ? (
           <div className="h-[600px] w-full bg-charcoal-light animate-pulse rounded-lg border border-white/5" />
        ) : (
          <div 
            ref={cardRef}
          ...
          >
            ...
            <div className="w-full lg:w-1/2 relative min-h-[400px] overflow-hidden">
              <div
                ...
                style={{
                  backgroundImage: `url("${workshop.image || '/assets/workshop-placeholder.jpg'}")`,
                  transform: isHovered 
              ...
              <div className="absolute top-6 right-6 bg-clay/95 backdrop-blur-md text-white px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] shadow-xl transition-all duration-500 group-hover:scale-110 group-hover:shadow-2xl">
                <span className="inline-block animate-pulse-subtle">
                   {workshop.seats > 0 ? `${workshop.seats} Spots Left` : "Sold Out"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 p-10 lg:p-20 flex flex-col justify-center gap-10 relative z-10 bg-charcoal-light/95 lg:bg-transparent">
              ...
              <div className={`flex flex-col sm:flex-row gap-6 items-start sm:items-center pt-2 transition-all duration-1000 delay-500 ${
                ...
                {/* MODIFIED: Link points to /workshops?id=... to trigger modal on page load */}
                <Link href={`/workshops?id=${workshop.id}`} className="w-full sm:w-auto">
                  <button className="group/btn relative w-full bg-rice-paper text-obsidian font-bold py-4 px-10 uppercase tracking-[0.15em] text-xs shadow-lg overflow-hidden transition-all duration-500 hover:shadow-2xl hover:scale-105">
                    <span className="relative z-10 transition-colors duration-300 group-hover/btn:text-white">
                      Reserve Spot (₹{workshop.price})
                    </span>
