...
//           <div className="bg-charcoal-light rounded-xl p-6 max-w-md w-full mx-4 transform transition-all duration-300 ease-out scale-95 opacity-0 animate-[modalFadeIn_0.2s_ease-out_forwards]">
...
//                     setItemToRemove(null);
//                   }}
//                   className="px-6 py-2 border border-stone-600 text-rice-paper rounded-lg hover:bg-charcoal transition-colors"
//                 >
//                   Cancel
//                 </button>
//                 <button
...
//                     }
//                   }}
//                   className="px-6 py-2 bg-clay text-charcoal rounded-lg hover:bg-opacity-90 transition-colors font-medium"
//                 >
//                   Remove
//                 </button>
//               </div>
...
//             <h1 className="text-3xl font-semibold font-sans text-rice-paper mb-8">
...
//                 {cartItems.length > 0 ? (
//                   cartItems.map((item) => (
//                     <div key={item.id} className="bg-charcoal-light p-5 rounded-2xl shadow-lg mb-6">
...
//                 <div className="sticky top-8 bg-charcoal-light rounded-xl border border-border-subtle overflow-hidden">
//                   <div className="p-6">
//                     <h3 className="text-xl font-semibold text-rice-paper mb-6 pb-4 border-b border-border-subtle">
//                       Order Summary
//                     </h3>
...
//                                     </div>
//                                   </div>
//                                   <span className="text-rice-paper font-medium">
//                                     ₹{calculateItemTotal(item.price, item.quantity).toLocaleString('en-IN')}
//                                   </span>
//                                 </div>
//                               ))}
