...
//         >
//           <button 
//             onClick={scrollToStories} // [!code ++] Added click handler
...
//   return (
//     <div 
//       id="stories" // [!code ++] Added ID here for scroll target
...
const journalEntries = [
  {
    ...
    readTime: '8 min',
    excerpt: 'In Japanese aesthetics, perfection is found not in symmetry, but in the weathered, the humble, the incomplete. Each crack in kintsugi becomes a golden vein of history.',
    // [!code ++] EXPANDED CONTENT
    content: `Wabi-sabi is the Japanese art of finding beauty in imperfection and profundity in nature. It accepts the natural cycle of growth, decay, and death. A philosophy that teaches us to see beauty not in spite of flaws, but because of them.
    
    In the context of pottery, this means embracing the accidental—the uneven glaze, the crackle pattern, the asymmetry of a hand-thrown bowl. These aren't mistakes; they are the signature of the moment it was created.
    
    When we repair broken pottery with gold (Kintsugi), we are exercising wabi-sabi. We are saying that the break is an important part of the object's history, not something to disguise. The piece becomes more beautiful for having been broken.`,
    image: 'https://images.unsplash.com/photo-1578749556568-bc2c40e68b61?w=1200&h=800&fit=crop',
    layout: 'full-bleed',
    tags: ['wabi-sabi', 'philosophy', 'aesthetics']
  },
