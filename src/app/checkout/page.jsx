  ...
  const handlePaymentSubmit = async (e) => {
    ...
    try {
      ...
      if (!process.env.NEXT_PUBLIC_RAZORPAY_KEY) {
        console.error('Missing NEXT_PUBLIC_RAZORPAY_KEY environment variable');
        setLoading(false);
      ...
      if (order.id) {
        ...
        const options = {
          ...
          handler: async function (response) {
            ...
            if (verification.success) {
              ...
              setLoading(false);
              alert(`Payment verification failed: ${verification.error || 'Unknown error'}. Please contact support.`);
            }
          },
          prefill: {
        ...
        setLoading(false);
        alert('Invalid order response received. Please try again.');
      }
    } catch (error) {
